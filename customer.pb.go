...
var file_protos_customer_proto_rawDesc = []byte{
	...
	0x32, 0xb4, 0x02, 0x0a, 0x0f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x53, 0x65, 0x72,
	...
	0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x2f, 0x3b, 0x70, 0x72,
...
var file_protos_customer_proto_depIdxs = []int32{
	5, // 0: protos.GetCustomerResponse.date_of_birth:type_name -> google.protobuf.Timestamp
	5, // 1: protos.CreateCustomerRequest.date_of_birth:type_name -> google.protobuf.Timestamp
	5, // 2: protos.UpdateCustomerRequest.date_of_birth:type_name -> google.protobuf.Timestamp
	0, // 3: protos.customerService.GetCustomer:input_type -> protos.GetCustomerRequest
	2, // 4: protos.customerService.CreateCustomer:input_type -> protos.CreateCustomerRequest
	3, // 5: protos.customerService.UpdateCustomer:input_type -> protos.UpdateCustomerRequest
	4, // 6: protos.customerService.DeleteCustomer:input_type -> protos.DeleteCustomerRequest
	1, // 7: protos.customerService.GetCustomer:output_type -> protos.GetCustomerResponse
	6, // 8: protos.customerService.CreateCustomer:output_type -> google.protobuf.Empty
	6, // 9: protos.customerService.UpdateCustomer:output_type -> google.protobuf.Empty
	6, // 10: protos.customerService.DeleteCustomer:output_type -> google.protobuf.Empty
